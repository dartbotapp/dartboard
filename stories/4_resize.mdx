...
import * as ResizeStories from './s2_resize.stories';
...
### Width & Height
Set the width of the dartboard using standard CSS. The component will automatically adjust its size
to fit the container.
<Canvas of={ResizeStories.Dimensions} />

### Dynamic Resize
Dynamically resizing the `<dartbot-dartboard>` element will automatically
redraw the board to <strong>maintain the resolution</strong>.
<Canvas of={ResizeStories.Dynamic} />

### Aspect ratio
By default the dartboard will maintain a 1:1 aspect ratio when you set the width.
