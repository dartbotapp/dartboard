...
// Set the hits array to draw hits on the board. Hits is an array of polar
// points (angle, radius) indicating the location of the hit.
dartboard.hits = [
...
dartboard.hits = [...dartboard.hits, polarPoint];
```
