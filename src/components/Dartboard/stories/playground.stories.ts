...
export const Playground: Story = {
  ...
  argTypes: {
    [Token.boardBg]: { description: 'Background color of the board', control: { type: 'color' } },
    [Token.sectorBg1]: { description: 'Board sector color 1', control: { type: 'color' } },
    [Token.sectorBg2]: { description: 'Board sector color 2', control: { type: 'color' } },
    [Token.sectorBg3]: { description: 'Board sector color 3', control: { type: 'color' } },
    [Token.sectorBg4]: { description: 'Board sector color 4', control: { type: 'color' } },
    [Token.wireShow]: { description: 'Show the wire between sections' },
    [Token.wireColor]: { description: 'Color of the wire', control: { type: 'color' } },
    [Token.wireWidth]: { description: 'Width of the wire', control: { type: 'number' } },
    [Token.wireShadowShow]: { description: 'Show a drop shadow under the wire' },
    [Token.wireShadowColor]: { description: 'Color of the wire shadow', control: { type: 'color' } },
    ...
    [Token.wireRingOffset]: { description: 'Distance the wire should extend outside the last ring' },
    [Token.numberShow]: { description: 'Show the sector numbers around the edge of the board' },
    [Token.numberColor]: { description: 'Color of the sector numbers', control: { type: 'color' } },
    [Token.numberWidth]: { description: 'Width of the line stroke for numbers' },
    [Token.numberInset]: { description: 'Distance the numbers should be inset from the edge of the board' },
    [Token.numberWireShow]: { description: 'Show the outer ring wire around the numbers' },
    [Token.numberWireColor]: { description: 'Color of the number wire', control: { type: 'color' } },
    [Token.numberWireWidth]: { description: 'Width of the line stroke for the number wire' }
  },
  render: (params) => {
    const style = `
      .story-playground {
